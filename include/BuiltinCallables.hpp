...
{
	public:
		static const Callable evaluate;
		static const Callable define;
		static const Callable if_;
		static const Callable defineFunction;
	...
	private:
		...
		static Value _evaluate(const EvaluationTree& expression, Scope& scope);
		...
		static Value _define(const EvaluationTree& expression, Scope& scope);
		...
		static Value _if(const EvaluationTree& expression, Scope& scope);
		...
		static Value _defineFunction(const EvaluationTree& expression, Scope& scope);
};
